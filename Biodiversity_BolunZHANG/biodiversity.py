...
species_count = species.category.count()
species_count
...
category_unique = species['category'].unique()
category_unique
...
conservation_statuses = species.groupby('conservation_status').scientific_name.count().reset_index()
...
conservation_statuses_fixed = species.groupby('conservation_status').scientific_name.count().reset_index()
conservation_statuses_fixed
...
x_values = range(len(protection_counts.conservation_status))
...
chi2_1, pval_1, dof_1, expected_1 = chi2_contingency(contingency)
pval_1
...
species_is_sheep = species[species.is_sheep == True].reset_index()
species_is_sheep
...
ax = plt.subplot()
x_values = range(len(obs_by_park.park_name))
